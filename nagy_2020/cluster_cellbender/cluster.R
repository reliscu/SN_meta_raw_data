...
# 552    1177    2403    3806    4902   49543 
summary(expr[[]]$nFeature_RNA)
# Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
# 501     896    1611    2002    2728    8995 
...
expr$Cell_Class[is.element(expr$Cell_Class, c(5))] <- "OG"
expr$Cell_Class[is.element(expr$Cell_Class, c(7))] <- "OPC"
expr$Cell_Class[is.element(expr$Cell_Class, c(2))] <- "ASC"
expr$Cell_Class[is.element(expr$Cell_Class, c(0, 3, 6, 7, 8, 10:12, 14, 15))] <- "EXC"
expr$Cell_Class[is.element(expr$Cell_Class, c(1, 4, 9, 13))] <- "INH"
expr$Cell_Class[is.element(expr$Cell_Class, c(12))] <- "NEU"
